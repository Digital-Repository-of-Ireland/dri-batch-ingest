...
The engine provides an interface for bulk ingesting XML metadata and media files into the DRI repository.

== BrowseEverything

The BrowseEverything gem, https://github.com/projecthydra/browse-everything, is used to select
